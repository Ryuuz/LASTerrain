...
void Collision::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Collision::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Collision::restart)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Collision::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Collision.data,
      qt_meta_data_Collision,  qt_static_metacall, nullptr, nullptr}
};
